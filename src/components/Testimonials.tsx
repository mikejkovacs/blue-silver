    ...
    <section className="py-20 bg-gradient-to-b from-purple-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Testimonials - Staggered Dynamic Layout */}
          <div className="relative max-w-6xl mx-auto h-auto">
            {/* First testimonial - Top Left */}
            <div 
              className="absolute top-0 left-0 w-80 animate-fade-in"
              style={{ animationDelay: '0.2s' }}
            >
              <div className="group relative transform rotate-[-2deg] hover:rotate-0 transition-all duration-500">
            ...
            <div 
              className="absolute top-12 right-0 w-72 animate-fade-in"
              style={{ animationDelay: '0.4s' }}
            >
              <div className="group relative transform rotate-[3deg] hover:rotate-0 transition-all duration-500">
            ...
            {/* Third testimonial - Bottom Left */}
            <div 
              className="absolute top-64 left-16 w-76 animate-fade-in"
              style={{ animationDelay: '0.6s' }}
            >
              <div className="group relative transform rotate-[1deg] hover:rotate-0 transition-all duration-500">
            ...
            <div 
              className="absolute top-72 right-20 w-64 animate-fade-in"
              style={{ animationDelay: '0.8s' }}
            >
              <div className="group relative transform rotate-[-1deg] hover:rotate-0 transition-all duration-500">
                <div className="bg-gradient-to-br from-cyan-800/80 via-teal-700/70 to-slate-900/50 p-5 rounded-2xl glass-effect backdrop-blur-md border border-cyan-400/20 hover:border-cyan-400/40 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-400/20 transition-all duration-500">
                  <div className="flex items-center justify-between mb-4">
                    <Quote className="w-7 h-7 text-cyan-400 group-hover:text-cyan-300 transition-colors duration-300" />
                    <div className="flex gap-1">
                      {[...Array(5)].map((_, i) => (
                  ...
                  <p className="text-gray-200 mb-4 italic leading-relaxed group-hover:text-white transition-colors duration-300 text-sm">
                    "Looking forward to seeing you again...Awesome show!"
                  </p>
                  <div className="flex items-center justify-between">
                    <p className="text-cyan-400 font-semibold text-xs group-hover:text-cyan-300 transition-colors duration-300">
                      — Fan Review
                    </p>
                    <Users className="w-4 h-4 text-gray-500 group-hover:text-cyan-400 transition-colors duration-300" />
                  </div>
                </div>
              </div>
            </div>
